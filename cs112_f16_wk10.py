_module = 'cs112_f16_wk10.py version 1.0'
# Place this file in the same folder as your week10 Python files.
# While you need to use this file to do your week10 exercises, students
# are not expected to look at nor to understand any code in this file.
# (At least not in week10!)
